...
INSERT INTO "new_Banner" ("createdAt", "customThemeId", "discountId", "id", "source", "text", "theme", "updatedAt") SELECT "createdAt", "customThemeId", "discountId", "id", "source", "text", "theme", "updatedAt" FROM "Banner";
DROP TABLE "Banner";
