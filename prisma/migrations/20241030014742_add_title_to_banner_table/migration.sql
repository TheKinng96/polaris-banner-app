...
INSERT INTO "new_Banner" ("createdAt", "customThemeId", "discountId", "id", "source", "status", "text", "theme", "updatedAt") SELECT "createdAt", "customThemeId", "discountId", "id", "source", "status", "text", "theme", "updatedAt" FROM "Banner";
DROP TABLE "Banner";
